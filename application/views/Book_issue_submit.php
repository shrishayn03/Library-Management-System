     ...
     <!-- MENU SECTION -->
       <?php include('include/side.php'); ?>
        ...
        <div id="content">
			...
			<?php echo form_open("home/product_filter");?>
			<table class="table table-striped">
    <thead>
      <tr>
        <th>Enter Member ID</th>
        <th><input type="text" name="mem_id" style="width:100%;"></th>
        <th><input type="submit" class="btn" name="AUTHOR" value="SEARCH" style="width:100%;"></th>
      </tr>
    </thead>
...
<?php if(isset($res))
{
	...
	<?php echo form_open("home/issue_book"); ?>
			...
			<div class="row">
				...
				<input type="text" class="form-control mb-2 mr-sm-2"  value="<?php echo $row1->mem_id; ?>" id="ID" placeholder="Enter ID" name="userid" readonly>
				</div>
			
			<div class="col-md-6">
				<label for="ID" class="mb-2 mr-sm-2">Name:</label>
				<input type="text" class="form-control mb-2 mr-sm-2" value="<?php echo $row1->mem_name; ?>" id="Name" placeholder="Enter Name" name="name" readonly>
				</div>
				
				
				<div class="col-md-6">
				<label for="ID" class="mb-2 mr-sm-2">Address:</label>
				<input type="text" class="form-control mb-2 mr-sm-2" value="<?php echo $row1->mem_Address; ?>" id="Name" placeholder="Enter Name" name="address" readonly>
				</div>
				
				<div class="col-md-6">
				<label for="ID" class="mb-2 mr-sm-2">Email:</label>
				<input type="email" class="form-control mb-2 mr-sm-2" value="<?php echo $row1->mem_email; ?>" id="email" placeholder="Enter Email" name="email" readonly>
				</div>
				
				<div class="col-md-6">
				<label for="pwd2" class="mb-2 mr-sm-2">Select Book:</label>
					<select name="book_name" class="form-control mb-2 mr-sm-2">
		<?php foreach($book as $row2)
				{
      
				?>
					<option><?php echo $row2->book_name; ?></option>
				<?php	}	?>
					</select>
			...
			<p>&nbsp;</p>
			<div class="row">
			<CENTER><input type="submit"  id="button" name="button" class="btn btn-danger" value="BOOK"></CENTER>
			</div>
			</div>
			<?php echo form_close(); ?>
<?php }} 
 ...
 ?>
			...
			<p><?php $mess=$this->session->flashdata('msg1'); 
			echo $mess;
			?></p>
			<?php } ?>
</div>
