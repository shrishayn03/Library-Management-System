...
<body class="padTop53 " >
     ...
     <!-- MENU SECTION -->
       <?php include('include/side.php'); ?>
		...
		if(isset($up1))
		{
			...
			ECHO form_open('home/update_author1');?>
			<p><?php 
    ...
    <thead>
      <tr>
        ...
        <th><input type="hidden" name="id" value="<?php echo $row->id; ?>" style="width:100%;"></th>
		<th><input type="text" name="author_name" value="<?php echo $row->author_name; ?>" style="width:100%;"></th>
...
else
{
    ...
    <thead>
      <tr>
        <th>Enter Author Name</th>
        <th><input type="text" name="author_name" style="width:100%;"></th>
...
$i=1;
	...
	foreach($up as $row1)
	{
	  ...
	  <tr>
        ...
        <td><a href="<?php echo base_url('home/del_author/'.$row1->id);?>">Delete</td>
		<td><a href="<?php echo base_url('home/update_author/'.$row1->id);?>">Update</td>
      </tr>
	<?php } ?>
    </tbody>
  </table>
