...
<body class="padTop53 " >
    ...
    <div id="wrap" >
     ...
     <!-- MENU SECTION -->
       <?php include('include/side.php'); ?>
        ...
        <h4 style="color:red;">Issue Book List</h4>
        <div class="container">
		<?php $mess=$this->session->flashdata('msg1'); 
			echo $mess;
			?>
	...
	foreach($data as $row1)
	{
      ...
      <tr>
        ...
        <td><a href="<?php echo base_url('home/sub_book/'.$row1->id); ?>"><input type="button" class="btn btn-primary" value="Submit Now" ></a></td>
      </tr>
   <?php } ?>
    </tbody>
  </table>
